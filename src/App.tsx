    ...
    <div style={{ ...styles.panel, ...tone.wrapper }}>
      <div style={{ padding: 14, display: "grid", gap: 12 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <button
            type="button"
            style={{ ...styles.button, flex: 1, opacity: canMoveBack ? 1 : 0.45 }}
          ...
          <button
            type="button"
            style={{ ...styles.primaryButton, flex: 1, opacity: canMoveNext ? 1 : 0.45 }}
  ...
  const filteredItems = useMemo(() => {
    ...
    return items.filter((item) => {
      const searchable = [
        item.patient,
        item.deviceName,
        getDeviceLabel(item.deviceCategory),
    ...
    <div style={styles.page}>
      <div style={styles.container}>
        <div style={styles.topBar}>
          ...
          <button type="button" style={styles.primaryButton} onClick={() => setOpen(true)}>
            + カード追加
          </button>
        </div>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", gap: 8 }}>
                          <div>
                            ...
                            <div style={{ fontSize: 12, color: "#64748b", marginTop: 4 }}>
                              {getDeviceLabel(item.deviceCategory)} / {item.deviceName}
                            </div>
                          </div>
        ...
        <div style={styles.modalBackdrop} onClick={() => setOpen(false)}>
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ marginTop: 16, display: "flex", justifyContent: "flex-end", gap: 8 }}>
              ...
              <button type="button" style={styles.primaryButton} onClick={addItem}>
                登録する
              </button>
            </div>
          </div>
